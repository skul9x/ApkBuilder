...
- 📋 **Logcat Viewer:** Trình xem log Android thời gian thực tích hợp, hỗ trợ lọc (Level/Tag/Message) và tìm kiếm thông minh.
- 🚀 **UI Virtualization:** Hiển thị mượt mà danh sách log cực lớn (>50k dòng) nhờ công nghệ ảo hóa (Virtualized List).
- 💾 **Export Log:** Xuất nội dung Logcat ra file `.txt` chỉ với một cú click.
